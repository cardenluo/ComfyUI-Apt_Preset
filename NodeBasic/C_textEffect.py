...
class XXXlay_text_sum:
    ...
    def apply_text(self, text, image, x, y, font_size, arrangement, text_rotation,
                  text_color, text_opacity, use_gradient, start_color, end_color, angle,
                  opacity_gradient_type, opacity_start, opacity_end,
                  stroke_width, stroke_color, stroke_opacity, stroke_type,
                  second_stroke_color, second_stroke_width,
                  shadow_x, shadow_y, shadow_color, shadow_opacity, shadow_blur,
                  shadow_type, multi_shadow_count, gradient_shadow_start, gradient_shadow_end,
                  outer_glow_color, outer_glow_opacity, outer_glow_radius,
                  inner_glow_color, inner_glow_opacity, inner_glow_radius,
                  font_file, texture_image=None, use_texture_fill=False, texture_scale=1.0,
                  emboss_effect=False, emboss_depth=2, emboss_light_color="#ffffff", emboss_shadow_color="#000000"):
