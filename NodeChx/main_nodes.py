...
class sum_editor:
    ...
    RETURN_NAMES = ("context", "model","positive", "negative", "latent", "vae","clip", "latent_image", )
    FUNCTION = "text"
    CATEGORY = "Apt_Preset/chx_load"
    ...
    def text(self, context=None, model=None, clip=None, positive=None, negative=None, 
            ...
            guidance=0, width=512, height=512):
...
#--------------条件--------------------------------------------------------------------------------
        ...
        return (context, model, positive, negative, latent, vae, clip, latent_image,)
...
class sum_create_chx:
    ...
    FUNCTION = "process_settings"
    CATEGORY = "Apt_Preset/chx_load/😺backup"
