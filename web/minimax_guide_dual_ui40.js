...
const AD_GUIDE_UI_VERSION = "2026.09.24-guide-v150-ref2-sample-height";
...
function normalizeFlowStageBeginSlots(node, force = false) {
    ...
    for (const link of graphLinkValues(graph)) {
        ...
        if (["stage_info", "stage_info_data", "stage_info_data1", "stage_info_data2", "stage_info_data3"].includes(inputName) && byName.stage_info != null) {
